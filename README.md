A simple image gallery built with react, using axios to fetch data from Flickr to display. Requires a config.js file in the src foder with a Flickr api key to work.
